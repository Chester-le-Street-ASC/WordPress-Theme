    ...
    <div class="frontpage1">
        <div class="container">
                ...
                <div class="row">
					<div class="col-md-7 front-page-drop-shadow">
                        <div class="header-content-inner">
							...
							<p>Established in 1975, we've developed in size and stature over the years, boasting tremendously talented young athletes who have achieved significant success at the local, national and international level.</p>
					...
					<div class="col-md-5 col-lg-4 ml-md-auto">
						<div class="widget cell">
							...
							<ul class="mb-0"><?php
								...
								echo '<li><a href="' . get_permalink($recent["ID"]) . '" class="frontpage-link">' .   $recent["post_title"].'</a> </li> ';
								}?>
							</ul>
						</div>
            ...
            <!--<div class="row row-flex row-flex-wrap">
                <div class="col-sm-4 col-xs-12"><div class="cell"><h3 class="m-t-0">Title</h3><p>Blah</p></div></div>
                <div class="col-sm-4 col-xs-12"><div class="cell"><h3 class="m-t-0">Title</h3><p>Blah</p></div></div>
                <div class="col-sm-4 col-xs-12"><div class="cell"><h3 class="m-t-0">Title</h3><p>Blah</p></div></div>
            </div>-->
        </div>
            ...
            <div class="row header-content align-items-center">
				<div class="col-md-6 col-lg-7">
					<div class="header-content-inner">
						...
						<div class="row">
							<div class="col"><p><a class="btn btn-light btn-block" href="https://www.facebook.com/Chester-le-Street-ASC-349933305154137/"><i class="fa fa-facebook" aria-hidden="true"></i> Facebook</a></p></div>
							<div class="col"><p><a class="btn btn-light btn-block" href="https://www.twitter.com/CLSASC1"><i class="fa fa-twitter" aria-hidden="true"></i> Twitter</a></p></div>
							<div class="col"><p><a class="btn btn-light btn-block" href="https://plus.google.com/+ChesterLeStreetASCUK"><i class="fa fa-google-plus" aria-hidden="true"></i> Google Plus</a></p></div>
						</div>
					</div>
				</div>	
				<div class="col-md-6 col-lg-4 ml-md-auto">
					<div class="widget cell mb-0">
						<h3>Tweets from Chester-le-Street ASC</h3>
						 <div class="tweet-embed"><a class="twitter-timeline" data-link-color="#FFF" href="https://twitter.com/CLSASC1" data-tweet-limit="1" data-theme="dark" data-show-replies="false" data-chrome="nofooter noborders noheader transparent" data-dnt="true">Tweets by CLSASC are loading now</a> <script async src="//platform.twitter.com/widgets.js" charset="utf-8"></script></div>
					</div>
                </div>
            </div>
        </div>
...
<div class="cls-global-footer cls-global-footer-body d-print-none" style="margin:0;background-color:#e7e7e7"><div class="container"><h4>This is a new version of our homepage!</h4>
It's currently in BETA but please <a href="mailto:websitefeedback@chesterlestreetasc.co.uk">let us know what you think!</a></div></div>
