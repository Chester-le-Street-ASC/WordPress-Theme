    ...
    <div class="row align-items-center">
      ...
      <div class="col-md-4">
        <div class="list-group list-group-flagship-content">
          ...
          <a href="#" class="list-group-item">Gala Programme</a>
          <a href="#" class="list-group-item">Live Results</a>
          <a href="https://www.chesterlestreetasc.co.uk/galahome/burnsmeetporgramme/" class="list-group-item">Programme of Events</a>
  ...
  <main class="row row-flex row-flex-wrap flex-panel-group flex-panel-link-group">
    ...
    <div class="col-xs-12 col-md-4">
      <div class="flex-panel flex-panel-default flex-panel-body flex-panel-top-blue flex-panel-link" style="padding-top:0;">
        ...
        <aside class="flex-panel-bottom-link chesterBlue fa-2x">
...
<div class="container galahome">
  <div class="row">
      ...
      <p class="mb-0">If you don't know your <abbr title="Personal Bests">PBs</abbr> from your <abbr title="Disqualifications">DQs</abbr>, <a  href="https://www.chesterlestreetasc.co.uk/newtoswimming">we can help</a>.</p>
      <hr>
      ...
      <div class="row">
        <div class="col">
          <p><a class="btn btn-fb btn-block" href="https://www.facebook.com/Chester-le-Street-ASC-349933305154137/"><i class="fa fa-facebook" aria-hidden="true"></i> Facebook</a></p>
        </div>
        <div class="col">
          <p><a class="btn btn-tweet btn-block" href="https://www.twitter.com/CLSASC"><i class="fa fa-twitter" aria-hidden="true"></i> Twitter</a></p>
        </div>
        <div class="col">
          <p><a class="btn btn-dark btn-block" href="https://plus.google.com/+ChesterLeStreetASCUK"><i class="fa fa-google-plus" aria-hidden="true"></i> Google Plus</a></p>
        </div>
      </div>
 		</div>
