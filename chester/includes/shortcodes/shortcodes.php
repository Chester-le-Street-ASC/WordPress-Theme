<?php
	...
	*/
	...
	function su_plugin_init() {
		...
		// Register styles
		wp_register_style( 'shortcodes-css', get_template_directory_uri() . '/includes/shortcodes/css/styles.css', false, su_get_version(), 'all' );
		wp_register_style( 'shortcodes-generator', get_template_directory_uri() . '/includes/shortcodes/css/generator.css', false, su_get_version(), 'all' );
		wp_register_style( 'jcarousel', get_template_directory_uri() . '/includes/shortcodes/css/jcarousel.css', false, su_get_version(), 'all' );
		wp_register_style( 'chosen', get_template_directory_uri() . '/includes/shortcodes/css/chosen.css', false, su_get_version(), 'all' );

		// Register scripts
		wp_register_script( 'shortcodes-js', get_template_directory_uri() . '/includes/shortcodes/js/init.js', array( 'jquery' ), su_get_version(), false );
		wp_register_script( 'shortcodes-generator', get_template_directory_uri() . '/includes/shortcodes/js/generator.js', array( 'jquery' ), su_get_version(), false );
		wp_register_script( 'jcarousel', get_template_directory_uri() . '/includes/shortcodes/js/jcarousel.js', array( 'jquery' ), su_get_version(), false );
		wp_register_script( 'chosen', get_template_directory_uri() . '/includes/shortcodes/js/chosen.js', array( 'jquery' ), su_get_version(), false );
			...
			<div id="su-generator">
				...
				<div id="su-generator-shell">
					<div id="su-generator-header">
						<select id="su-generator-select" data-placeholder="<?php _e( 'Select shortcode', 'csb-admin' ); ?>" data-no-results-text="<?php _e( 'Shortcode not found', 'csb-admin' ); ?>">
					...
					<div id="su-insert-vector-icon" style="display:none;">
						<div class="su-csb-generator-icon-select">
					...
					<input type="hidden" name="su-generator-url" id="su-generator-url" value="<?php echo get_template_directory_uri() . '/includes/shortcodes'; ?>" />
