    ...
    <div id="carousel1" class="carousel slide hidden-xs" data-ride="carousel" style="margin-top:-20px;">
      ...
      <div class="carousel-inner" role="listbox">
        <div class="item active"><img src="<?php echo get_bloginfo('template_directory');?>/img/slider/slider1.jpg" alt="First slide image" class="center-block">
        ...
        <div class="item"><img src="<?php echo get_bloginfo('template_directory');?>/img/slider/slider3.jpg" alt="Third slide image" class="center-block">
          <div class="carousel-caption">
            <h3>Join Us</h3>
