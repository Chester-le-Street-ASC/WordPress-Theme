       ...
       <!-- Portfolio Item Heading -->
          	<div class="container-fluid">
            	<div class="center-block text-center" id="topimage-text">
            	    <img class="img-responsive center-block" src="<?php echo get_template_directory_uri();?>/img/stylish/halloffamelogo.png" srcset="<?php echo get_template_directory_uri();?>/img/stylish/halloffamelogo@2x.png 2x" alt="Hall of Fame Logo">
