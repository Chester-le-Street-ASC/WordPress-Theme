...
<div class="topimage-halloffame hidden-print">
       <!-- Portfolio Item Heading -->
          	<div class="container">
            	<div class="m-x-auto text-center" id="topimage-text">
            	    <img class="img-fluid m-x-auto" src="<?php echo get_template_directory_uri();?>/img/stylish/halloffamelogo.png" alt="Hall of Fame Logo">
