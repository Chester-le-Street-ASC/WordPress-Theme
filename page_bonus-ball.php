<?php /* Template Name: Bonus Ball (PHP) */ ?>
      ...
      <div class="row">
		...
		<?php if (have_posts()) : while (have_posts()) : the_post(); ?>
         		...
         		<div id="post-<?php the_ID(); ?>" <?php post_class('post blog-post'); ?>>
                        ...
                        <!-- 	THE LATEST BALLS SYSTEM REQUIRES MYSQL, PHP AND PHPMYADMIN AS DATA IS DYNAMICALLY SOURCED FROM THE bitnami_wordpress SQL DATABASE.
                        		IF THERE IS NO CONNECTION, THE SYSTEM WILL NOT BE UP TO DATE.
                        ...
                        <div class="well">
                        <ul>
                        <li>Half of the weekly scheme funds will be offered as prize money, up to a maximum of £25.00 per week</li>
                        <li>The winning bonus ball number will be taken from each Saturday’s National Lottery Draw</li>
                        <li>Pay £5 every 5 weeks</li>
                        </ul>
                        </div>
                        </div>
                        </div>
